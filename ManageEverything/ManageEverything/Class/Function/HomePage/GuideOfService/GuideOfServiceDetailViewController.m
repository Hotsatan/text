//
//  GuideOfServiceDetailViewController.m
//  ManageEverything
//
...
@interface GuideOfServiceDetailViewController ()<UITextViewDelegate>
...
@implementation GuideOfServiceDetailViewController

- (void)initializeDataSource {
    [self showLoading];
    [NetWorkHandler guideServiceOfDetailsWithParams:@{@"people_id":[NSString stringWithFormat:@"%@",[Common getUserInfo][@"people_id"]], @"id":_serviceID == nil ? @"" : _serviceID} completionHandle:^(id content) {
        NSLog(@"%@",content);
...
- (void)initializeInterface {
    ...
    self.navigationItem.title = @"办事指南详情";
